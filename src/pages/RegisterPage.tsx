...
import { Facebook, Lock, Mail, User, AlertCircle, ArrowRight, ShieldCheck, ExternalLink } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">
          Tạo tài khoản PAGE MANAGER
        </h1>
        <p className="mt-1 text-sm text-slate-600">
          Bắt đầu quản trị Facebook Page tập trung với cơ sở dữ liệu thật
        </p>
      </div>
        ...
        <div className="bg-white py-8 px-6 shadow-sm rounded-2xl border border-slate-200 sm:px-10">
          {!isConfigured && (
            <div className="mb-6 p-4 rounded-xl bg-amber-50 border border-amber-200 text-amber-900 text-xs leading-relaxed space-y-1.5">
              ...
              <p>
                Để kích hoạt chức năng đăng ký, vui lòng cấu hình các biến <code className="font-mono bg-amber-100 px-1 py-0.5 rounded">VITE_FIREBASE_API_KEY</code> và <code className="font-mono bg-amber-100 px-1 py-0.5 rounded">VITE_FIREBASE_PROJECT_ID</code> trong cài đặt môi trường.
              </p>
            </div>
          )}
          ...
          {isOperationNotAllowed ? (
            <div className="mb-6 p-4 rounded-xl bg-amber-50 border border-amber-300 text-slate-800 text-xs space-y-2.5 shadow-xs">
              ...
              <p className="text-slate-700 leading-relaxed">
                Dự án Firebase <strong className="font-mono text-slate-900">fit-world-rghtt</strong> cần bật phương thức <strong>Email/Password</strong> một lần duy nhất để cho phép người dùng đăng ký:
              </p>
              <ol className="list-decimal pl-4 space-y-1 text-slate-600">
                <li>Bấm nút bên dưới để mở trang <strong>Sign-in method</strong> trên Firebase Console.</li>
                <li>Chọn <strong>Email/Password</strong>, gạt công tắc sang <strong>Enable</strong>.</li>
                <li>Nhấn <strong>Save (Lưu)</strong> rồi quay lại đây nhấn <strong>Đăng ký ngay</strong>.</li>
              </ol>
              <div className="pt-1">
                <a
                ...
                >
                  <span>Mở Firebase Console (1-Click)</span>
